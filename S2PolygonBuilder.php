...
<S2Point
, Multiset
<S2Point>> edge = edges.entrySet().iterator().next();
...
<S2Edge> unusedEdges) {
List
<S2Loop> loops = Lists.newArrayList();
...
List
<S2Edge> unusedEdges = Lists.newArrayList();
...
// The path so far.
List
<S2Point> path = Lists.newArrayList();

// Maps a vertex to its index in "path".
Map
<S2Point
, Integer> index = Maps.newHashMap();
path.add(v0);
path.add(v1);
...
List
<S2Edge> edgesCopy = Lists.newArrayList();
    for (Map.Entry
    <S2Point
    , Multiset
    <S2Point>> edge : this.edges.entrySet()) {
        S2Point v0 = edge.getKey();
        Multiset
            ...
            *#/
            ...
            <S2Point>> edge : edges.entrySet()) {
                ...
                <S2Point> vset = edge.getValue();
                    ...
                    Map
                    <S2Point
                    , S2Point> mergeMap = Maps.newHashMap();
                    Stack
                    <S2Point> frontier = new Stack
                        <S2Point>();
                            List
                            <S2Point> mergeable = Lists.newArrayList();

                                for (Map.Entry
                                <S2CellId
                                , MarkedS2Point> entry : index.entries()) {
                                ...
                                *#/
                                ...
                                <S2CellId
                                , MarkedS2Point> delegate = HashMultimap.create();
                                ...
                                <MarkedS2Point> pointSet = get(id);
                                    ...
                                    *#/
                                    ...
                                    <S2Point> output) {
                                        ...
                                        List
                                        <S2CellId> neighbors = Lists.newArrayList();
