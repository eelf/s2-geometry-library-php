...
class SmokeTest extends PHPUnit_Framework_TestCase {
     ...
     */
    public static function GreatEarthDistance(S2LatLng $a, S2LatLng $b) {
    ...
    public static function greatCircleBearing(S2LatLng $a, S2LatLng $b) {
    ...
    public static function greatCircleDestination(S2LatLng $a, $bearing, $distance) {
    ...
    public static function encodeLocation(S2LatLng $s2ll){
